...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format">
   ...
   <xsl:template name="transaction" match="transaction">
		<fo:table-row font-size="8pt" text-align="center">
			...
			<fo:table-cell border-left-width="0.5pt" border-left-style="solid"><fo:block><xsl:value-of select="solde"/></fo:block></fo:table-cell>
			...
			<fo:table-cell border-left-width="0.5pt" border-left-style="solid"><fo:block><xsl:value-of select="motif"/></fo:block></fo:table-cell>
		</fo:table-row>	
	</xsl:template>
   ...
   <xsl:template name="entete">
		<fo:table>
			...
			<fo:table-body>
	     	<fo:table-row>
					<fo:table-cell text-align="left" number-columns-spanned="2"><fo:block font-size="8pt"><xsl:value-of select="titre"/></fo:block></fo:table-cell>
			...
			<fo:table-body>
				<fo:table-row border-width="0.5pt solid" background-color="silver" border-style="solid" font-size="10pt" text-align="center">
					...
					<fo:table-cell><fo:block>Motif</fo:block></fo:table-cell>
				</fo:table-row>	
			</fo:table-body>
		</fo:table>
   </xsl:template>
